...
<h3 class="m-0">Products Details</h3>
</div>
</div>
</div>
...
<input type="text" class="form-control" id="inputEmail4" placeholder="Product Name" name="pro_name">
</div>
<div class="col-md-6">
...
<input type="text" class="form-control" id="inputEmail4" placeholder="Description" name="meta_title">
</div>
<div class="col-md-6">
<label class="form-label" for="inputEmail4">Stock</label>
<input type="text" class="form-control" id="inputEmail4" placeholder="Keyword" name="stock">
</div>
...
<input type="text" class="form-control" id="inputEmail4" placeholder="Description" name="mrp">
</div>
<div class="col-md-6">
<label class="form-label" for="inputEmail4">Selling Price</label>
<input type="text" class="form-control" id="inputEmail4" placeholder="Keyword" name="selling_price">
</div>
...
<input type="file" class="form-control" id="inputEmail4" placeholder="Keyword" name="pro_image">
</div>
...
<div class="col-md-6">
    ...
    <select name="pro_cate_sub" class="form-control">
    <option value="">--select--</option>
    <?php foreach($check as $value){ ?>
    <option value="<?php echo $value['cate_id'];?>"><?php echo ucwords( $value['name']);?></option>
    <?php } ?>
...
<button type="submit" name="add-products" class="btn btn-primary">Add Products</button>
</form>
</div>
</div>
</div>
